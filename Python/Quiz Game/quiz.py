...
def intro_message():
    ...
    """
    print("Welcome to this movie quiz! \nAre you ready to test your knowledge about movie characters?")
    print("There are a total of 6 questions, you can skip a question anytime by typing 'skip'")
    input("You will 3 attempts for every question, Press any key to start the fun ;) ")
    return True
...
print_dictionary()
print("Thanks for playing! @Jobanpreet Singh ❤ ❤")